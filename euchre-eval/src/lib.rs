...
///
/// Recognised names are `"random"` and `"heuristic"`. New agents should be added
/// here so the CLI and any tooling can name them.
...
pub const BUILTIN_AGENTS: &[&str] = &["random", "heuristic"];
